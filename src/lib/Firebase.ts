...
export async function importPlaylistsSpotify(data: any[], user: User) {
    ...
    console.log("ALL THE PLAYLISTS ADDED TO DB");

}

export async function importSongsSpotify(data: any[], user: User) {
    ...
    console.log("ALL THE SONGS ADDED TO DB");

}

export async function importArtistsSpotify(data: any[], user: User) {
    ...
    console.log("ALL THE ARTISTS ADDED TO DB");
